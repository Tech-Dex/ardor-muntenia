<script>
	...
	let predaiOptionalHeading = data.data.heading;
	let predaiOptionalContent = data.data.content;
...
<Fullpage>
	<FullpageSection title="Optional Dezbatere, Oratorie si Retorica">
		<HeadingTextLeft
			image={predaiOptionalHeading.image}
			title={predaiOptionalHeading.title}
			description={predaiOptionalHeading.description}
		/>
	</FullpageSection>
	{#each predaiOptionalContent as content, i}
		...
		{/if}
	{/each}
	<FullpageSection title="Predai Optional Retro">

<script>
	...
	let predaiCursuriHeading = data.data.heading;
	let predaiCursuriContent = data.data.content;
...
<Fullpage>
	<FullpageSection title="Curs acreditat">
		<HeadingTextLeft
			image={predaiCursuriHeading.image}
			title={predaiCursuriHeading.title}
			description={predaiCursuriHeading.description}
		/>
	</FullpageSection>
	{#each predaiCursuriContent as content, i}
		...
		{/if}
	{/each}
	<FullpageSection title="Predai Cursuri Retro">

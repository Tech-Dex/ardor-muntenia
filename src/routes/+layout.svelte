...
<header>
	...
	<nav>
		<ul>
			...
			<li class="dropdown">
				<a class:active={path === "/cine-suntem"}
			...
			<li class="dropdown">
				<a class:active={path === "/cum-fac-dezbateri" } href="/cum-fac-dezbateri">Cum fac Dezbateri?</a>
				<div class="dropdown-content">
...
<footer>
	<div>
		<div class="footer-socials">
			<a href="facebook.com">
				<Icon icon={facebookIcon} color="var(--color-tertiary)" width="30" />
			</a>
			<Icon icon={slashForward} color="var(--color-tertiary)" width="30" />
			<a href="instagram.com">
				<Icon icon={instagramIcon} color="var(--color-tertiary)" width="30" />
			</a>
			<Icon icon={slashForward} color="var(--color-tertiary)" width="30" />
			<a href="youtube.com">
				<Icon icon={youtubeIcon} color="var(--color-tertiary)" width="30" />
			</a>
			<Icon icon={slashForward} color="var(--color-tertiary)" width="30" />
			<a href="linkedin.com">
				<Icon icon={linkedinIcon} color="var(--color-tertiary)" width="30" />
			</a>
		</div>
		<div class="footer-details">
			<p class="footer-header">ARDOR MUNTENIA</p>
...
<style>
    ...
    footer .footer-details .footer-header {
        grid-area: footer-details-title;
        color: var(--color-tertiary);
        font-size: 1.5rem;
        font-weight: 700;
				margin: 0 !important;
